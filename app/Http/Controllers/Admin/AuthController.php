...
class AuthController extends BaseController
{
    ...
    public function getSignin()
    {
        ...
        if (Sentinel::check()) {
            if (Sentinel::getUser()->is_chemist_user == 0) {
        ...
        try {
            ...
            if (Sentinel::authenticate(Input::only('email', 'password'), Input::get('remember-me', false))) {
               ...
               if (Sentinel::getUser()->is_chemist_user == 0) {
                ...
                //Redirect to the chemist all orders page
                return Redirect::route("orders")->with('success', Lang::get('auth/message.signin.success'));
            }
